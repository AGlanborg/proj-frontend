...
export default async function upload(obj, url) {
    ...
    data.content += `\n${obj.saljare}, ${obj.kopare}, ${obj.arbetstyp}, ${obj.antal}, ${obj.typ}, ${obj.leverantor}, ${obj.text}, ${obj.info}, ${obj.valuta}, ${obj.mangd}, ${obj.inprisex}, ${obj.inprisin}, ${obj.procent}, ${obj.oh}, ${obj.totalt}, ${obj.fakturanum}, ${obj.kommentar}, ${obj.inpris}, ${obj.start}, ${obj.slut}, ${obj.perioder}, ${obj.upfront}, ${obj.rest}, ${obj.internfakt}, ${obj.intakt}, ${obj.scan}, ${obj.now},`
